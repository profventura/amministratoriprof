...
$router->post('/settings/ricevute/create-manual', [SettingsController::class, 'createManualReceipt']);
$router->post('/settings/ricevute/preview-pdf', [SettingsController::class, 'previewManualReceiptPdf']);
$router->post('/settings/ricevute/preview-pdf-raw', [SettingsController::class, 'previewReceiptPdfRaw']);
